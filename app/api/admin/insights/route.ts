...
export async function GET() {
  try {
    ...
    // Try to use AI Gateway, but fall back to basic insights if unavailable
    try {
...
Generate insights in the required JSON format.`,
      ...
      // AI Gateway unavailable - use fallback insights based on raw data
      console.warn("AI Gateway unavailable, using fallback insights:", aiError);
      insights = {
        salesTrends: {
